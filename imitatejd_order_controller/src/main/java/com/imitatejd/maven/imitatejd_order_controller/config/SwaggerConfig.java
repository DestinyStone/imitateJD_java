package com.imitatejd.maven.imitatejd_order_controller.config;
...
public class SwaggerConfig {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()  //选择以下的两项
                .apis(RequestHandlerSelectors.basePackage("com.imitatejd.maven.imitatejd_order_controller.controller")) //添加扫描包
